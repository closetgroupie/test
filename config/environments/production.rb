Closetgroupie::Application.configure do
  ...
  config.assets.precompile += %w( search.js activity.js shop.js item.js add-items.js infinite-scroll.js filters.js closets.js activities.js landing.css active_admin.css active_admin.js become-a-curator.js )
