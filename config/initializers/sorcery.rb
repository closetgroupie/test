...
Rails.application.config.sorcery.configure do |config|
  ...
  #
  # XXX: Twitter does not supply e-mail address right now, which means that it
  # should not be used for registration until we can provide a form for filling
  # information
  # config.twitter.key = "sCcaz8a7FevnNMjUn6aYw"
  # config.twitter.secret = "DToePcNYxNWAkNKDNob8OuV344ChiqUXCwvEDF3r8"
